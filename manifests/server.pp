...
class mysql::server::master {
  ...
  $mysql_ssl_flag                 = hiera('mysql_ssl_flag',false)
  $ssl_ca                         = hiera('mysql_ssl_ca','')
  $ssl_cert                       = hiera('mysql_ssl_cert','')
  $ssl_key                        = hiera('mysql_ssl_key','')
...
class mysql::server::slave {
  ...
  $report_host                    = hiera('mysql_report_host','')
  $mysql_ssl_flag                 = hiera('mysql_ssl_flag',false)
  ...
  $mysql_database_ignore          = hiera('mysql_database_ignore',false)
